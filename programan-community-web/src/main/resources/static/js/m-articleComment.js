...
function open_article_comment_list_page() {
	loadTabMenu('html/m-articleComment.html', loadArticleCommentList)
}

function loadArticleCommentList() {
	$(function() {
		var table = $("#articlecommentdatatable").DataTable({
			"processing": true,
			"serverSide": true,
			'ajax': {
				'contentType': 'application/json',
				'url': callurl + "/articleComment/tableList",
				'type': 'POST',
				'data': function(d) {
...
//			});
	...
	$('#purgeArticleCommentBtn').click(function() {
...
function deleteArticleComment(delid) {
	$.ajax({
		type: "post",
		url: callurl + "/articleComment/delete/" + delid,
		async: true,
		dataType: 'json',
		...
		success: function(data) {
			...
			setTimeout(function(){
				open_article_comment_list_page();
			},500)
		},
